...
config.jsConcatenatedAdminScriptsName = pkg.jsConcatenatedAdminScriptsName;
config.concatenatedAdminScripts = pkg.jsConcatenatedAdminScripts;
config.concatenatedAdminVendorScripts = pkg.jsConcatenatedAdminVendorScripts;
config.allConcatenatedAdminScripts = config.concatenatedAdminVendorScripts.concat( config.concatenatedAdminScripts );

// get an array of negated files to exclude js files that will be concatenated
config.negatedConcatenatedAdminScripts = config.concatenatedAdminScripts.map( function (s) {
    return '!' + s;
});
config.negatedConcatenatedAdminVendorScripts = config.concatenatedAdminVendorScripts.map( function (s) {
    return '!' + s;
});
config.negatedAllConcatenatedAdminScripts = config.negatedConcatenatedAdminScripts.concat(config.negatedConcatenatedAdminVendorScripts);
...
/* gulp-size */
config.size = {
    src: [config.destination + '/css/**/*.min.css', config.destination + '/js/**/*.min.js']
};
