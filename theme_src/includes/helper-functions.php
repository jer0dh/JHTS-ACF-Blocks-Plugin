 ...
 * @license      GPL-2.0+
 *
 * Modified by Jerod Hammerstein to add width = 100% and height so can have icons that are not square
 */
function acf_blocks_ea_icon( $atts = array() ) {
