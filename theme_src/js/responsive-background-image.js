...
if (typeof(themeJs) === 'undefined') {
    window.themeJs = {};
}

/**
 * Function to call to load a responsive background image to parent element, then removing original img
 * @param el
 */
themeJs.loadBgImg = function (el) {
    let $this = $(el);
